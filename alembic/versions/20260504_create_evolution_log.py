...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["target_genome_id"],
            ["genome_registry.genome_id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_evolution_log_genome_id"),
        "evolution_log",
        ["target_genome_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_evolution_log_action"), "evolution_log", ["action"], unique=False
    )
    op.create_index(
        op.f("ix_evolution_log_timestamp"), "evolution_log", ["timestamp"], unique=False
    )
