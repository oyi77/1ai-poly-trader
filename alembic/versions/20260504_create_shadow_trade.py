...
def upgrade():
    ...
    op.create_index(
        op.f("ix_shadow_trade_genome_id"), "shadow_trade", ["genome_id"], unique=False
    )
    op.create_index(
        op.f("ix_shadow_trade_strategy_name"),
        "shadow_trade",
        ["strategy_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_shadow_trade_stage"), "shadow_trade", ["stage"], unique=False
    )
