...
def upgrade() -> None:
    ...
    try:
        op.create_index(
            "ix_trades_settled_mode",
            "trades",
            ["settled", "trading_mode"],
            unique=False,
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "ix_trades_ticker_settled",
            "trades",
            ["market_ticker", "settled"],
            unique=False,
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "idx_trades_blockchain_verified",
            "trades",
            ["blockchain_verified"],
            unique=False,
        )
    ...
    try:
        op.create_index(
            "idx_trades_clob_order_id", "trades", ["clob_order_id"], unique=False
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "ix_pending_approvals_status", "pending_approvals", ["status"], unique=False
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "ix_trades_market_ticker", "trades", ["market_ticker"], unique=False
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "ix_trades_trading_mode", "trades", ["trading_mode"], unique=False
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "ix_trades_market_end_date", "trades", ["market_end_date"], unique=False
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "ix_bot_state_last_sync_at", "bot_state", ["last_sync_at"], unique=False
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "ix_trades_mode_settled_result",
            "trades",
            ["trading_mode", "settled", "result"],
            unique=False,
        )
    except Exception as e:
...
def downgrade() -> None:
    ...
    try:
        op.drop_constraint(
            "fk_settlement_events_trade_id", "settlement_events", type_="foreignkey"
        )
    except Exception:
        pass
    ...
    try:
        op.drop_constraint(
            "fk_trade_context_trade_id", "trade_context", type_="foreignkey"
        )
    except Exception:
        pass
