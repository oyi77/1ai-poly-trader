...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_hft_execution_records_signal_id"),
        "hft_execution_records",
        ["signal_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_hft_execution_records_created_at"),
        "hft_execution_records",
        ["created_at"],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        op.f("ix_hft_execution_records_created_at"), table_name="hft_execution_records"
    )
    op.drop_index(
        op.f("ix_hft_execution_records_signal_id"), table_name="hft_execution_records"
    )
