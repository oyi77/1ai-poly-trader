...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "result", sa.String, nullable=True
        ),  # Enum-like values: win/loss/push
    ...
    op.create_table(
        ...
        ),  # Enum-like: active/warned/paused/killed
    ...
    op.create_index(
        "ix_strategy_outcomes_strategy_market_type",
        "strategy_outcomes",
        ["strategy", "market_type"],
    )
    op.create_index(
        "ix_strategy_outcomes_settled_at", "strategy_outcomes", ["settled_at"]
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_strategy_outcomes_strategy_market_type", table_name="strategy_outcomes"
    )
