...
def upgrade() -> None:
    ...
    with op.batch_alter_table("trades", schema=None) as batch_op:
        ...
        try:
            batch_op.create_check_constraint("ck_trades_size_positive", "size > 0")
        except Exception as e:
            print(
                f"Check constraint ck_trades_size_positive already exists or error: {e}"
            )

        # Add CHECK constraint for size < 1000 (reasonable max position)
        try:
            batch_op.create_check_constraint("ck_trades_size_max", "size <= 1000")
        except Exception as e:
        ...
        try:
            ...
            print(
                f"Check constraint ck_trades_entry_price_range already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_trades_confidence_range already exists or error: {e}"
            )

        # Add CHECK constraint for edge_at_entry reasonable range [-1, 1]
        try:
            batch_op.create_check_constraint(
                "ck_trades_edge_range", "edge_at_entry >= -1 AND edge_at_entry <= 1"
            )
        except Exception as e:
        ...
        try:
            ...
            print(
                f"Check constraint ck_trades_model_probability_range already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_trades_market_price_range already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_trades_direction_valid already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_trades_result_valid already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_trades_trading_mode_valid already exists or error: {e}"
            )
    ...
    with op.batch_alter_table("signals", schema=None) as batch_op:
        ...
        try:
            batch_op.create_check_constraint(
                "ck_signals_confidence_range", "confidence >= 0 AND confidence <= 1"
            )
        except Exception as e:
            print(
                f"Check constraint ck_signals_confidence_range already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_signals_model_probability_range already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_signals_market_price_range already exists or error: {e}"
            )

        # Add CHECK constraint for edge reasonable range [-1, 1]
        try:
            batch_op.create_check_constraint(
                "ck_signals_edge_range", "edge >= -1 AND edge <= 1"
            )
        except Exception as e:
            print(
                f"Check constraint ck_signals_edge_range already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_signals_kelly_fraction_range already exists or error: {e}"
            )

        # Add CHECK constraint for suggested_size > 0
        try:
            batch_op.create_check_constraint(
                "ck_signals_suggested_size_positive", "suggested_size > 0"
            )
        except Exception as e:
            print(
                f"Check constraint ck_signals_suggested_size_positive already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_signals_direction_valid already exists or error: {e}"
            )
    ...
    with op.batch_alter_table("pending_approvals", schema=None) as batch_op:
        ...
        try:
            batch_op.create_check_constraint(
                "ck_pending_approvals_size_positive", "size > 0"
            )
        except Exception as e:
            print(
                f"Check constraint ck_pending_approvals_size_positive already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_pending_approvals_confidence_range already exists or error: {e}"
            )
        ...
        try:
            ...
            print(
                f"Check constraint ck_pending_approvals_status_valid already exists or error: {e}"
            )
    ...
    with op.batch_alter_table("trade_context", schema=None) as batch_op:
        ...
        try:
            ...
            print(
                f"Check constraint ck_trade_context_confidence_range already exists or error: {e}"
            )
    ...
    try:
        op.create_index(
            "uq_trades_clob_order_id", "trades", ["clob_order_id"], unique=True
        )
    except Exception as e:
    ...
    try:
        op.create_index(
            "uq_trades_clob_idempotency_key",
            "trades",
            ["clob_idempotency_key"],
            unique=True,
        )
    except Exception as e:
        print(
            f"Unique index uq_trades_clob_idempotency_key already exists or error: {e}"
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("pending_approvals", schema=None) as batch_op:
        ...
        try:
            batch_op.drop_constraint(
                "ck_pending_approvals_confidence_range", type_="check"
            )
        except Exception:
            pass
        try:
            batch_op.drop_constraint(
                "ck_pending_approvals_size_positive", type_="check"
            )
        except Exception:
            pass
    ...
    with op.batch_alter_table("signals", schema=None) as batch_op:
        ...
        try:
            batch_op.drop_constraint(
                "ck_signals_suggested_size_positive", type_="check"
            )
        except Exception:
            pass
        try:
        ...
        try:
            batch_op.drop_constraint(
                "ck_signals_model_probability_range", type_="check"
            )
        except Exception:
            pass
        try:
