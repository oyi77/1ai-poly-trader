...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_genome_shadow_trade_genome_id", "genome_shadow_trade", ["genome_id"]
    )
    op.create_index(
        "ix_genome_shadow_trade_genome_registry_id",
        "genome_shadow_trade",
        ["genome_registry_id"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_genome_shadow_trade_genome_registry_id", table_name="genome_shadow_trade"
    )
