...
def upgrade():
    ...
    op.create_index(
        "ix_clob_events_market_id", "clob_events", ["market_id"], unique=False
    )
    op.create_index(
        "ix_clob_events_block_number", "clob_events", ["block_number"], unique=False
    )
    op.create_index(
        "ix_clob_events_timestamp", "clob_events", ["timestamp"], unique=False
    )
