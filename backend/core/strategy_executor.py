...
# ---------------------------------------------------------------------------
# Shared helpers for _execute_decision_paper_or_kalshi / _execute_decision_live_clob
# ---------------------------------------------------------------------------
...
class _PreflightResult:
    """Result from _preflight_checks — everything needed to create a trade."""
    ...
    fee: Optional[float]
    context: object  # ModeExecutionContext
...
def _record_trade(
    ...
    trade = Trade(
        ...
        market_end_date=pf.market_end_date,
        token_id=token_id,
