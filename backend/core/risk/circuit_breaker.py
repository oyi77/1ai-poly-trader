...
STRATEGY_MIN_WIN_RATE = settings.STRATEGY_MIN_WIN_RATE
STRATEGY_MIN_PNL_RATIO = settings.STRATEGY_MIN_PNL_RATIO
STRATEGY_WINRATE_LOOKBACK_TRADES = settings.STRATEGY_WINRATE_LOOKBACK_TRADES
STRATEGY_PNL_LOOKBACK_DAYS = settings.STRATEGY_PNL_LOOKBACK_DAYS
