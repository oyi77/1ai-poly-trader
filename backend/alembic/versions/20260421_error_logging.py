...
def upgrade() -> None:
    ...
    try:
        ...
        op.create_index(
            "ix_error_logs_timestamp", "error_logs", ["timestamp"], unique=False
        )
        op.create_index(
            "ix_error_logs_error_type", "error_logs", ["error_type"], unique=False
        )
        op.create_index(
            "ix_error_logs_endpoint", "error_logs", ["endpoint"], unique=False
        )
        op.create_index(
            "ix_error_logs_user_id", "error_logs", ["user_id"], unique=False
        )
        op.create_index(
            "ix_error_logs_request_id", "error_logs", ["request_id"], unique=False
        )
        op.create_index(
            "idx_error_logs_type_timestamp",
            "error_logs",
            ["error_type", "timestamp"],
            unique=False,
        )
        op.create_index(
            "idx_error_logs_endpoint_timestamp",
            "error_logs",
            ["endpoint", "timestamp"],
            unique=False,
        )
