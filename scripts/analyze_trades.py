...
for r in rows:
    ...
    if "bitcoin" in name or "btc" in name or "price of bitcoin" in name:
        categories["Bitcoin/BTC"] += 1
        cat_usdc["Bitcoin/BTC"] += usdc
    elif (
        "trump" in name
        or "xi jinping" in name
        or "eurovision" in name
        or "hantavirus" in name
        or "gemini" in name
        or "s&p" in name
        or "elon" in name
    ):
        categories["Trump/Politics"] += 1
        cat_usdc["Trump/Politics"] += usdc
    elif (
        "cubs" in name
        or "phillies" in name
        or "orioles" in name
